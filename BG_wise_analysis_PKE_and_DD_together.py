...
for k in range(50):
    ...
    print (' Generated DD A', DD_A)
    print (' Generated DD B', DD_B)
    print (' Generated DD AB', DD_AB)
    print (' Generated  DD O', DD_O)
    ...
    print ('DD BG A', count_a_DD)
    print ('DD BG B', count_b_DD)
    print ('DD BG AB', count_ab_DD)
    print ('DD BG O', count_o_DD)
